...
> **Стабильная версия: 0.2.0.** Сейчас приоритет — стабильность и исправление ошибок. Новые функции выходят без установленного графика.
...
[Что изменилось в версии 0.2.0](CHANGELOG.md).
