---
name: flood-screen-design
description: Specify flood.md screen hierarchy, navigation, surfaces and progressive disclosure. Use when composing a new screen or changing ownership, page structure, modal/drawer choice or a user journey.
---

# Flood screen design

Complete the [project bootstrap](../../agent-contract.md#bootstrap). Read [ownership and disclosure](../../principles.md), the matching R01–R14 [recipe](../../flows.md) and its referenced C01–C25 [components](../../components.md). For companion work, also read [buddy.md](../../buddy.md).
...
| Global optional companion | C25 transient nonmodal panel over the workspace; never reserved width, a permanent sidebar or a task-embedded agent |
...
5. For new compound compositions use [the reference procedure](../../research.md); established Quiet Workbench recipes can proceed from the existing study.
